...
namespace game
{
	...
	public:
		...
		private:
			static const std::uintptr_t rva = 0x0189AD80; // 0x0189D6E0
		...
		private:
			static const std::uintptr_t rva = 0x01EA1E1F; // 0x01EA4B6F
		...
		private:
			static const std::uintptr_t rva = 0x01EAAAF9; // 0x01EAD849
